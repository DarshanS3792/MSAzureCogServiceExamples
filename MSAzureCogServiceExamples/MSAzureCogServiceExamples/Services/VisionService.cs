...
namespace MSAzureCogServiceExamples.Services
{
    ...
    {
        public static async Task<string> UploadAndDetect(Stream stream)
        {
            var visionClient = new VisionServiceClient(CognitiveServicesKeys.VisionKey, "https://westus.api.cognitive.microsoft.com/vision/v1.0");
